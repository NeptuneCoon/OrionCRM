...
var zoneInit = {
     ...
     * 渲染省下拉框 
    */
    renderProvince: function (provinceId,contain) {
    ...
    // 渲染直辖市
    renderMunicipality: function (municipalityId) {
        $('#' + municipalityId).find('option').not(":first").remove();
        var arr = ['北京', '上海', '天津', '重庆'];
        for (var i = 0; i < arr.length; i++) {
            var city = arr[i];
            var opt = '<option value=' + city + '>' + city + '</option>';
            $('#' + municipalityId).append(opt);
        }
    }
};
var provinceList = [
